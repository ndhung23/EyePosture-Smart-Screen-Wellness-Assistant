  ...
  "packages/billing/dist/crypto/signer.js"(exports2) {
    ...
    function toBase64Url(bytes) {
      ...
      if (typeof btoa === "function") {
        ...
        base64 = node_buffer_1.Buffer.from(binary, "binary").toString("base64");
      }
    ...
    function fromBase64Url(str) {
      ...
      if (typeof atob === "function") {
        ...
        binary = node_buffer_1.Buffer.from(base64, "base64").toString("binary");
      }
...
var require_sepay_provider = __commonJS({
  "packages/billing/dist/providers/sepay-provider.js"(exports2) {
    ...
    var SePayBillingProvider2 = class _SePayBillingProvider {
      ...
      constructor(config) {
        this.config = {
          apiKey: config?.apiKey || node_process_1.default.env.SEPAY_WEBHOOK_SECRET || node_process_1.default.env.SECRET_KEY || node_process_1.default.env.SEPAY_API_KEY || "sepay_api_key_eyeposture_demo",
          accountNumber: config?.accountNumber || node_process_1.default.env.PAYMENT_BANK_ACCOUNT || node_process_1.default.env.PAYMENT_BANK_VIRTUAL_ACCOUNT || node_process_1.default.env.SEPAY_ACCOUNT_NUMBER || "4661398013",
          bankName: config?.bankName || node_process_1.default.env.PAYMENT_BANK_CODE || node_process_1.default.env.SEPAY_BANK_NAME || "BIDV",
          accountHolder: config?.accountHolder || node_process_1.default.env.PAYMENT_BANK_ACCOUNT_NAME || node_process_1.default.env.SEPAY_ACCOUNT_HOLDER || "NGUYEN DUY HUNG",
      ...
      verifyApiKey(authHeader) {
        ...
        const validKeys = Array.from(new Set([
          this.config.apiKey,
          node_process_1.default.env.SEPAY_WEBHOOK_SECRET,
          node_process_1.default.env.SECRET_KEY,
          node_process_1.default.env.SEPAY_API_KEY
        ].filter(Boolean)));
...
var http, crypto2, fs, path, import_billing, EyePostureApiServer;
